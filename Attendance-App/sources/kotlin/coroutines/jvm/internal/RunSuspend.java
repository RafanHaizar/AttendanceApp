...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1756getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result2) {
        synchronized (this) {
            this.result = Result.m1344boximpl(result2);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m1354unboximpl());
                }
            }
        }
    }
