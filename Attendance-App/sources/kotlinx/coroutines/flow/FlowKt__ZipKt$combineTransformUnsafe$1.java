...
@DebugMetadata(mo129c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1", mo130f = "Zip.kt", mo131i = {}, mo132l = {273}, mo133m = "invokeSuspend", mo134n = {}, mo135s = {})
...
public final class FlowKt__ZipKt$combineTransformUnsafe$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo129c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1", mo130f = "Zip.kt", mo131i = {}, mo132l = {273}, mo133m = "invokeSuspend", mo134n = {}, mo135s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1 */
    /* compiled from: Zip.kt */
    public static final class C00841 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C00841 r0 = new C00841(r4, continuation);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (CombineKt.combineInternal((FlowCollector) this.L$0, flowArr, access$nullArrayFactory, new C00841((Continuation<? super C00841>) null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        final Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> function3 = this.$transform;
        InlineMarker.mark(0);
        CombineKt.combineInternal((FlowCollector) this.L$0, flowArr, access$nullArrayFactory, new C00841((Continuation<? super C00841>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
