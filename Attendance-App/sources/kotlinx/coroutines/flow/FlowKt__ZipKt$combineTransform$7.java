...
@DebugMetadata(mo129c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo130f = "Zip.kt", mo131i = {}, mo132l = {308}, mo133m = "invokeSuspend", mo134n = {}, mo135s = {})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo129c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo130f = "Zip.kt", mo131i = {}, mo132l = {308}, mo133m = "invokeSuspend", mo134n = {}, mo135s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C00832 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C00832 r0 = new C00832(r4, continuation);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                }, new C00832((Continuation<? super C00832>) null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        }, new C00832((Continuation<? super C00832>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
