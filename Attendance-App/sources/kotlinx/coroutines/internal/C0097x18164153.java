...
public final class C0097x18164153 extends Lambda implements Function1<Throwable, Throwable> {
    final /* synthetic */ Constructor $constructor$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C0097x18164153(Constructor constructor) {
        super(1);
    ...
    public final Throwable invoke(Throwable e) {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m1345constructorimpl((Throwable) newInstance);
