...
final class Version {
    ...
    private Version(int versionNumber2, int[] alignmentPatternCenters2, ECBlocks ecBlocks1, ECBlocks ecBlocks2, ECBlocks ecBlocks3, ECBlocks ecBlocks4) {
        this.versionNumber = versionNumber2;
        this.alignmentPatternCenters = (int[]) alignmentPatternCenters2.clone();
    ...
    public static final class ECBlocks {
        ...
        ECBlocks(int ecCodewordsPerBlock2, ECB ecBlocks1, ECB ecBlocks2) {
            this.ecCodewordsPerBlock = ecCodewordsPerBlock2;
