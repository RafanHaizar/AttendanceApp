...
public class PdfException extends RuntimeException {
    ...
    /* renamed from: AppendModeRequiresADocumentWithoutErrorsEvenIfRecoveryWasPossible */
    public static final String f1238x22deddac = "Append mode requires a document without errors, even if recovery is possible.";
    ...
    /* renamed from: CannotRemoveMarkedContentReferenceBecauseItsPageWasAlreadyFlushed */
    public static final String f1239x7c8643be = "Cannot remove marked content reference, because its page has been already flushed.";
    ...
    /* renamed from: CertificateIsNotProvidedDocumentIsEncryptedWithPublicKeyCertificate */
    public static final String f1240xf3889bd1 = "Certificate is not provided. Document is encrypted with public key certificate, it should be passed to PdfReader constructor with properties. See ReaderProperties#setPublicKeySecurityParams() method.";
    ...
    /* renamed from: ContentStreamMustNotInvokeOperatorsThatSpecifyColorsOrOtherColorRelatedParameters */
    public static final String f1241xa6840a7b = "Content stream must not invoke operators that specify colors or other color related parameters in the graphics state.";
    ...
    /* renamed from: DuringDecompressionMultipleStreamsInSumOccupiedMoreMemoryThanAllowed */
    public static final String f1242xd7ab4c0c = "During decompression multiple streams in sum occupied more memory than allowed. Please either check your pdf or increase the allowed single decompressed pdf stream maximum size value by setting the appropriate parameter of ReaderProperties's MemoryLimitsAwareHandler.";
    ...
    /* renamed from: PageAlreadyFlushedUseAddFieldAppearanceToPageMethodBeforePageFlushing */
    public static final String f1243xa4aabec1 = "The page has been already flushed. Use PdfAcroForm#addFieldAppearanceToPage() method before page flushing.";
    ...
    /* renamed from: StructureElementDictionaryShallBeAnIndirectObjectInOrderToHaveChildren */
    public static final String f1244x971f4981 = "Structure element dictionary shall be an indirect object in order to have children.";
    ...
    /* renamed from: TagTreePointerIsInInvalidStateItPointsAtFlushedElementUseMoveToRoot */
    public static final String f1245xc7bb476d = "TagTreePointer is in invalid state: it points at flushed element. Use TagTreePointer#moveToRoot.";

    /* renamed from: TagTreePointerIsInInvalidStateItPointsAtRemovedElementUseMoveToRoot */
    public static final String f1246x67c488aa = "TagTreePointer is in invalid state: it points at removed element use TagTreePointer#moveToRoot.";
    ...
    /* renamed from: ThisPkcs7ObjectHasMultipleSignerinfosOnlyOneIsSupportedAtThisTime */
    public static final String f1247xd9ab8c46 = "This PKCS#7 object has multiple SignerInfos. Only one is supported at this time.";
    ...
    /* renamed from: WhenAddingObjectReferenceToTheTagTreeItMustBeConnectedToNotFlushedObject */
    public static final String f1248x4ac180a9 = "When adding object reference to the tag tree, it must be connected to not flushed object.";
    ...
    public PdfException setMessageParams(Object... messageParams2) {
