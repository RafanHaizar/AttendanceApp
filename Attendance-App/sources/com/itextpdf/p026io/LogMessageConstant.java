...
/* renamed from: com.itextpdf.io.LogMessageConstant */
public final class LogMessageConstant {
    ...
    /* renamed from: ENCRYPTED_PAYLOAD_FILE_SPEC_SHALL_HAVE_AFRELATIONSHIP_FILED_EQUAL_TO_ENCRYPTED_PAYLOAD */
    public static final String f1188xfdc6407c = "Encrypted payload file spec shall have 'AFRelationship' filed equal to 'EncryptedPayload'";

    /* renamed from: ENCRYPTION_ENTRIES_P_AND_ENCRYPT_METADATA_NOT_CORRESPOND_PERMS_ENTRY */
    public static final String f1189x3e742566 = "Encryption dictionary entries P and EncryptMetadata have value that does not correspond to encrypted values in Perms key.";
    ...
    /* renamed from: FONT_PROPERTY_OF_STRING_TYPE_IS_DEPRECATED_USE_STRINGS_ARRAY_INSTEAD */
    public static final String f1190x1cf9924b = "The \"Property.FONT\" property with values of String type is deprecated, use String[] as property value type instead.";
    ...
    /* renamed from: IMAGE_HAS_ICC_PROFILE_WITH_INCOMPATIBLE_NUMBER_OF_COLOR_COMPONENTS_COMPARED_TO_BASE_COLOR_SPACE_IN_INDEXED_COLOR_SPACE */
    public static final String f1191xe908ea8 = "Image has icc profile with incompatible number of color components compared to base color space in image indexed color space. The icc profile will be ignored.";

    /* renamed from: IMAGE_HAS_ICC_PROFILE_WITH_INCOMPATIBLE_NUMBER_OF_COLOR_COMPONENTS_COMPARED_TO_COLOR_SPACE */
    public static final String f1192x4563ea8d = "Image has icc profile with incompatible number of color components compared to image color space. The icc profile will be ignored.";

    /* renamed from: IMAGE_HAS_INCORRECT_OR_UNSUPPORTED_BASE_COLOR_SPACE_IN_INDEXED_COLOR_SPACE_OVERRIDDEN_BY_ICC_PROFILE */
    public static final String f1193x3d959059 = "Image has incorrect or unsupported base color space in indexed color space, it will be overridden by one based on embedded icc profile.";

    /* renamed from: IMAGE_HAS_INCORRECT_OR_UNSUPPORTED_COLOR_SPACE_OVERRIDDEN_BY_ICC_PROFILE */
    public static final String f1194xbd0142fe = "Image has incorrect or unsupported color space, that will be overridden by one based on embedded icc profile.";
    ...
    /* renamed from: PNG_IMAGE_HAS_ICC_PROFILE_WITH_INCOMPATIBLE_NUMBER_OF_COLOR_COMPONENTS */
    public static final String f1195xe55b147c = "Png image has color profile with incompatible number of color components.";
    ...
    /* renamed from: UNABLE_TO_APPLY_PAGE_DEPENDENT_PROP_UNKNOWN_PAGE_ON_WHICH_ELEMENT_IS_DRAWN */
    public static final String f1196x4ac94ef4 = "Unable to apply page dependent property, because the page on which element is drawn is unknown. Usually this means that element was added to the Canvas instance that was created not with constructor taking PdfPage as argument. Not processed property: {0}";
