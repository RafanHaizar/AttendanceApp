...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    private int mTargetDensity = CipherSuite.TLS_DH_RSA_WITH_AES_128_GCM_SHA256;
    ...
    public void setTargetDensity(int density) {
        if (this.mTargetDensity != density) {
            this.mTargetDensity = density == 0 ? CipherSuite.TLS_DH_RSA_WITH_AES_128_GCM_SHA256 : density;
