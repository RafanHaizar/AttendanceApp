...
public final class MetadataItem extends Table {
    ...
    /* renamed from: id */
    public int mo17615id() {
        int o = __offset(4);
        if (o != 0) {
            return this.f1054bb.getInt(this.bb_pos + o);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        int o = __offset(6);
        return (o == 0 || this.f1054bb.get(this.bb_pos + o) == 0) ? false : true;
    }

    public short sdkAdded() {
        int o = __offset(8);
        if (o != 0) {
            return this.f1054bb.getShort(this.bb_pos + o);
        }
        return 0;
    }
    ...
    public int codepoints(int j) {
        int o = __offset(16);
        if (o != 0) {
            return this.f1054bb.getInt(__vector(o) + (j * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector obj) {
        int o = __offset(16);
        if (o != 0) {
            return obj.__assign(__vector(o), this.f1054bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem obj, int j) {
            return obj.__assign(MetadataItem.__indirect(__element(j), this.f1048bb), this.f1048bb);
        }
    }
}
