...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0603R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C06061 r4 = new CardViewDelegate() {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0603R.styleable.CardView, defStyleAttr, C0603R.C0605style.CardView);
        if (a.hasValue(C0603R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(C0603R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (hsv[2] > 0.5f) {
                i = getResources().getColor(C0603R.C0604color.cardview_light_background);
            } else {
                i = getResources().getColor(C0603R.C0604color.cardview_dark_background);
            }
            backgroundColor = ColorStateList.valueOf(i);
        }
        float radius = a.getDimension(C0603R.styleable.CardView_cardCornerRadius, 0.0f);
        float elevation = a.getDimension(C0603R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation2 = a.getDimension(C0603R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0603R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0603R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0603R.styleable.CardView_contentPadding, 0);
        rect.left = a.getDimensionPixelSize(C0603R.styleable.CardView_contentPaddingLeft, defaultPadding);
        rect.top = a.getDimensionPixelSize(C0603R.styleable.CardView_contentPaddingTop, defaultPadding);
        rect.right = a.getDimensionPixelSize(C0603R.styleable.CardView_contentPaddingRight, defaultPadding);
        rect.bottom = a.getDimensionPixelSize(C0603R.styleable.CardView_contentPaddingBottom, defaultPadding);
        if (elevation > maxElevation2) {
            maxElevation = elevation;
        } else {
            maxElevation = maxElevation2;
        }
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0603R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0603R.styleable.CardView_android_minHeight, 0);
        a.recycle();
