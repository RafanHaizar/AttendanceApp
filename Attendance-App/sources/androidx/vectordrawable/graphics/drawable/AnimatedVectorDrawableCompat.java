...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private AnimatedVectorDrawableCompat(Context context, AnimatedVectorDrawableCompatState state, Resources res) {
        ...
        C10441 r0 = new Drawable.Callback() {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x005a A[Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }] */
    ...
    public static androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat create(android.content.Context r8, int r9) {
        ...
        L_0x0033:
            ...
            android.content.res.XmlResourceParser r3 = r2.getXml(r9)     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r3)     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
        L_0x003f:
            int r5 = r3.next()     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            r6 = r5
            r7 = 2
        ...
        L_0x004b:
            ...
            android.content.res.Resources r5 = r8.getResources()     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            android.content.res.Resources$Theme r7 = r8.getTheme()     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat r0 = createFromXmlInner(r8, r5, r3, r4, r7)     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            return r0
        L_0x005a:
            org.xmlpull.v1.XmlPullParserException r5 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            java.lang.String r7 = "No start tag found"
            r5.<init>(r7)     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            throw r5     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
        L_0x0062:
            r3 = move-exception
