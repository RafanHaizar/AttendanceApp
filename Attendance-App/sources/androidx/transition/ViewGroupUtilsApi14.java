...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            C10271 r0 = new LayoutTransition() {
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C1010R.C1013id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C1010R.C1013id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C1010R.C1013id.transition_layout_save, (Object) null);
