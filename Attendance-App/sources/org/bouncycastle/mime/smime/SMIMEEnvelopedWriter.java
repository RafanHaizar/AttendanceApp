...
public class SMIMEEnvelopedWriter extends MimeWriter {
    ...
    public static class Builder {
        ...
        private static final String[] stdValues = {"application/pkcs7-mime; name=\"smime.p7m\"; smime-type=enveloped-data", "attachment; filename=\"smime.p7m\"", ResourceResolver.BASE64IDENTIFIER, "S/MIME Encrypted Message"};
        String contentTransferEncoding = ResourceResolver.BASE64IDENTIFIER;
    ...
    public OutputStream getContentStream() throws IOException {
        ...
        try {
            if (!ResourceResolver.BASE64IDENTIFIER.equals(this.contentTransferEncoding)) {
                return new ContentOutputStream(this.envGen.open(SMimeUtils.createUnclosable(this.mimeOut), this.outEnc), (OutputStream) null);
            }
