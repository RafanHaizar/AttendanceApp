...
public class BasicMimeParser implements MimeParser {
    ...
    private InputStream processStream(Headers headers2, InputStream inputStream) {
        return headers2.getContentTransferEncoding().equals(ResourceResolver.BASE64IDENTIFIER) ? new Base64InputStream(inputStream) : headers2.getContentTransferEncoding().equals("quoted-printable") ? new QuotedPrintableInputStream(inputStream) : inputStream;
    }
