...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    /* renamed from: c */
    private TBSCertList.CRLEntry f691c;
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f691c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f691c.equals(((X509CRLEntryObject) obj).f691c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f691c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f691c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f691c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f691c.getExtensions() != null;
    }
