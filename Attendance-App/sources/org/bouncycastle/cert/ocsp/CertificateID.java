...
public class CertificateID {
    ...
    public CertificateID(DigestCalculator digestCalculator, X509CertificateHolder x509CertificateHolder, BigInteger bigInteger) throws OCSPException {
        this.f114id = createCertID(digestCalculator, x509CertificateHolder, new ASN1Integer(bigInteger));
    }
    ...
    public static CertificateID deriveCertificateID(CertificateID certificateID, BigInteger bigInteger) {
        return new CertificateID(new CertID(certificateID.f114id.getHashAlgorithm(), certificateID.f114id.getIssuerNameHash(), certificateID.f114id.getIssuerKeyHash(), new ASN1Integer(bigInteger)));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f114id.toASN1Primitive().equals(((CertificateID) obj).f114id.toASN1Primitive());
    }

    public ASN1ObjectIdentifier getHashAlgOID() {
        return this.f114id.getHashAlgorithm().getAlgorithm();
    }

    public byte[] getIssuerKeyHash() {
        return this.f114id.getIssuerKeyHash().getOctets();
    }

    public byte[] getIssuerNameHash() {
        return this.f114id.getIssuerNameHash().getOctets();
    }

    public BigInteger getSerialNumber() {
        return this.f114id.getSerialNumber().getValue();
    }

    public int hashCode() {
        return this.f114id.toASN1Primitive().hashCode();
    }
    ...
    public boolean matchesIssuer(X509CertificateHolder x509CertificateHolder, DigestCalculatorProvider digestCalculatorProvider) throws OCSPException {
        try {
            return createCertID(digestCalculatorProvider.get(this.f114id.getHashAlgorithm()), x509CertificateHolder, this.f114id.getSerialNumber()).equals(this.f114id);
