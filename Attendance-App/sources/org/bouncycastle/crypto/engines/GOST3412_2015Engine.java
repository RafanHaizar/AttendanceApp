...
public class GOST3412_2015Engine implements BlockCipher {
    ...
    /* renamed from: C */
    private void m90C(byte[] bArr, int i) {
        Arrays.clear(bArr);
        bArr[15] = (byte) i;
        m92L(bArr);
    }
    ...
    /* renamed from: F */
    private void m91F(byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    /* renamed from: S */
    private void m94S(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            bArr[i] = f386PI[unsignedByte(bArr[i])];
        }
    }

    /* renamed from: X */
    private void m95X(byte[] bArr, byte[] bArr2) {
        for (int i = 0; i < bArr.length; i++) {
        ...
        if (bArr.length == this.KEY_LENGTH) {
            ...
            for (int i5 = 1; i5 < 5; i5++) {
                for (int i6 = 1; i6 <= 8; i6++) {
                    m90C(bArr7, ((i5 - 1) * 8) + i6);
                    m91F(bArr7, bArr2, bArr3);
                }
                int i7 = i5 * 2;
