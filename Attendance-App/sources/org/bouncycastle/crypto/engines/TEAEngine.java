...
public class TEAEngine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i4 = 0; i4 != 32; i4++) {
            bytesToInt2 -= (((bytesToInt << 4) + this.f426_c) ^ (bytesToInt + i3)) ^ ((bytesToInt >>> 5) + this.f427_d);
            bytesToInt -= (((bytesToInt2 << 4) + this.f424_a) ^ (bytesToInt2 + i3)) ^ ((bytesToInt2 >>> 5) + this.f425_b);
            i3 += 1640531527;
        }
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i5 = 0; i5 != 32; i5++) {
            i4 -= 1640531527;
            i3 += (((bytesToInt2 << 4) + this.f424_a) ^ (bytesToInt2 + i4)) ^ ((bytesToInt2 >>> 5) + this.f425_b);
            bytesToInt2 += (((i3 << 4) + this.f426_c) ^ (i3 + i4)) ^ ((i3 >>> 5) + this.f427_d);
        }
    ...
    private void setKey(byte[] bArr) {
        if (bArr.length == 16) {
            this.f424_a = bytesToInt(bArr, 0);
            this.f425_b = bytesToInt(bArr, 4);
            this.f426_c = bytesToInt(bArr, 8);
            this.f427_d = bytesToInt(bArr, 12);
            return;
        }
