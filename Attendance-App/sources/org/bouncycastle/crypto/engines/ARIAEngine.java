...
public class ARIAEngine implements BlockCipher {
    ...
    /* renamed from: C */
    private static final byte[][] f349C = {Hex.decodeStrict("517cc1b727220a94fe13abe8fa9a6ee0"), Hex.decodeStrict("6db14acc9e21c820ff28b1d5ef5de2b0"), Hex.decodeStrict("db92371d2126e9700324977504e8c90e")};
    ...
    /* renamed from: A */
    protected static void m83A(byte[] bArr) {
        byte b = bArr[0];
        byte b2 = bArr[1];
        byte b3 = bArr[2];
        byte b4 = bArr[3];
    ...
    /* renamed from: FE */
    protected static void m84FE(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL2(bArr);
        m83A(bArr);
    }
    ...
    /* renamed from: FO */
    protected static void m85FO(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL1(bArr);
        m83A(bArr);
    }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        if (this.roundKeys == null) {
            ...
            while (i3 < length) {
                int i4 = i3 + 1;
                m85FO(bArr3, this.roundKeys[i3]);
                m84FE(bArr3, this.roundKeys[i4]);
                i3 = i4 + 1;
            }
            int i5 = i3 + 1;
            m85FO(bArr3, this.roundKeys[i3]);
