...
public final class DERMacData {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            switch (C02761.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()]) {
                case 1:
                case 2:
                    return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), (C02761) null);
                case 3:
                case 4:
                    return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), (C02761) null);
                default:
    ...
    /* synthetic */ DERMacData(byte[] bArr, C02761 r2) {
        this(bArr);
    }
