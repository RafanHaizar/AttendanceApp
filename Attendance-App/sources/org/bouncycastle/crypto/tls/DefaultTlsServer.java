...
public abstract class DefaultTlsServer extends AbstractTlsServer {
    ...
    public TlsKeyExchange createDHEKeyExchange(int i) {
        return new TlsDHEKeyExchange(i, this.supportedSignatureAlgorithms, (TlsDHVerifier) null, getDHParameters());
    }

    /* access modifiers changed from: protected */
    public TlsKeyExchange createDHKeyExchange(int i) {
        return new TlsDHKeyExchange(i, this.supportedSignatureAlgorithms, (TlsDHVerifier) null, getDHParameters());
    }
