...
public class PSKTlsServer extends AbstractTlsServer {
    ...
    public TlsKeyExchange createPSKKeyExchange(int i) {
        return new TlsPSKKeyExchange(i, this.supportedSignatureAlgorithms, (TlsPSKIdentity) null, this.pskIdentityManager, (TlsDHVerifier) null, getDHParameters(), this.namedCurves, this.clientECPointFormats, this.serverECPointFormats);
    }
