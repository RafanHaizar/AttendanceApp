...
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    public KGCMBlockCipher(BlockCipher blockCipher) {
        ...
        this.f525iv = new byte[blockSize2];
        this.multiplier = createDefaultMultiplier(blockSize2);
        this.f524b = new long[(blockSize2 >>> 3)];
        this.macBlock = null;
    }
    ...
    private void calculateMac(byte[] bArr, int i, int i2, int i3) {
        int i4 = i + i2;
        while (i < i4) {
            xorWithInput(this.f524b, bArr, i);
            this.multiplier.multiplyH(this.f524b);
            i += this.blockSize;
        }
        long j = (BodyPartID.bodyIdMax & ((long) i2)) << 3;
        long[] jArr = this.f524b;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            byte[] bArr = this.f525iv;
            Arrays.fill(bArr, (byte) 0);
            System.arraycopy(nonce, 0, this.f525iv, bArr.length - nonce.length, nonce.length);
            ...
            byte[] bArr3 = this.f525iv;
            Arrays.fill(bArr3, (byte) 0);
            System.arraycopy(iv, 0, this.f525iv, bArr3.length - iv.length, iv.length);
        ...
        this.ctrEngine.init(true, new ParametersWithIV(keyParameter, this.f525iv));
