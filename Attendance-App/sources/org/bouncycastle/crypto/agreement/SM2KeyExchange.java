...
public class SM2KeyExchange {
    ...
    /* renamed from: S1 */
    private byte[] m26S1(Digest digest2, ECPoint eCPoint, byte[] bArr) {
    ...
    /* renamed from: S2 */
    private byte[] m27S2(Digest digest2, ECPoint eCPoint, byte[] bArr) {
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1).shiftLeft(this.f130w).subtract(BigInteger.valueOf(1))).setBit(this.f130w);
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i, byte[] bArr, CipherParameters cipherParameters) {
        ...
        if (!this.initiator || bArr3 != null) {
            ...
            if (this.initiator) {
                ...
                if (Arrays.constantTimeAreEqual(m26S1(this.digest, calculateU, calculateInnerHash), bArr3)) {
                    return new byte[][]{kdf, m27S2(this.digest, calculateU, calculateInnerHash)};
                }
            ...
            return new byte[][]{kdf2, m26S1(this.digest, calculateU, calculateInnerHash2), m27S2(this.digest, calculateU, calculateInnerHash2)};
        }
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f130w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
    }
}
