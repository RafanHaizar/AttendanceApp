...
public abstract class Nat128 {
    ...
    /* renamed from: M */
    private static final long f845M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m131eq(int[] iArr, int[] iArr2) {
        for (int i = 3; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i15 = i2 + 5;
                int i16 = i12;
                long j15 = (((long) iArr2[i15]) & 4294967295L) + (j12 >>> 32);
                int i17 = i2 + 6;
                ...
                long j19 = (((long) iArr2[i17]) & 4294967295L) + (j15 >>> 32) + (j18 >>> 32);
                int i19 = (int) j17;
                iArr2[i16] = (i18 >>> 31) | (i19 << 1);
                int i20 = i19 >>> 31;
                int i21 = (int) j18;
                iArr2[i15] = i20 | (i21 << 1);
                int i22 = i21 >>> 31;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i12 = i11 >>> 31;
                int i13 = (int) (4294967295L & j18);
                iArr2[5] = i12 | (i13 << 1);
                int i14 = i13 >>> 31;
                int i15 = (int) j19;
                iArr2[6] = i14 | (i15 << 1);
                iArr2[7] = ((iArr2[7] + ((int) (j19 >>> 32))) << 1) | (i15 >>> 31);
                return;
            }
            i2 = i4;
            i3 = i6;
