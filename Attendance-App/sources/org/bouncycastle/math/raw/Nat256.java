...
public abstract class Nat256 {
    ...
    /* renamed from: M */
    private static final long f849M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m135eq(int[] iArr, int[] iArr2) {
        for (int i = 7; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                long j54 = (((long) iArr2[i31]) & 4294967295L) + (j46 >>> 32) + (j53 >>> 32);
                long j55 = j44;
                long j56 = ((long) iArr[i + 7]) & 4294967295L;
                int i34 = i2 + 13;
                long j57 = j53 & 4294967295L;
                long j58 = (((long) iArr2[i34]) & 4294967295L) + (j54 >>> 32);
                int i35 = i2 + 14;
                ...
                long j68 = (((long) iArr2[i35]) & 4294967295L) + (j58 >>> 32) + (j67 >>> 32);
                int i37 = (int) j60;
                ...
                int i47 = i46 >>> 31;
                int i48 = i2 + 15;
                iArr2[i48] = i47 | ((iArr2[i48] + ((int) (j68 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
