...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f734q = Curve25519FieldElement.f738Q;
    ...
    public Curve25519() {
        super(f734q);
        this.f714a = fromBigInteger(C_a);
        this.f715b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f739x, 0, iArr, i3);
            int i5 = i3 + 8;
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f739x, 0, iArr, i5);
            i3 = i5 + 8;
        }
