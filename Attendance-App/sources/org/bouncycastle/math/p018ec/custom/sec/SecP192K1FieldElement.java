...
public class SecP192K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f765Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFEE37"));

    /* renamed from: x */
    protected int[] f766x;

    public SecP192K1FieldElement() {
        this.f766x = Nat192.create();
    }

    public SecP192K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f765Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP192K1FieldElement");
        }
        this.f766x = SecP192K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP192K1Field.add(this.f766x, ((SecP192K1FieldElement) eCFieldElement).f766x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat192.create();
        SecP192K1Field.addOne(this.f766x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        Mod.invert(SecP192K1Field.f763P, ((SecP192K1FieldElement) eCFieldElement).f766x, create);
        SecP192K1Field.multiply(create, this.f766x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat192.m133eq(this.f766x, ((SecP192K1FieldElement) obj).f766x);
    }
    ...
    public int getFieldSize() {
        return f765Q.bitLength();
    }

    public int hashCode() {
        return f765Q.hashCode() ^ Arrays.hashCode(this.f766x, 0, 6);
    }

    public ECFieldElement invert() {
        int[] create = Nat192.create();
        Mod.invert(SecP192K1Field.f763P, this.f766x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat192.isOne(this.f766x);
    }

    public boolean isZero() {
        return Nat192.isZero(this.f766x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.multiply(this.f766x, ((SecP192K1FieldElement) eCFieldElement).f766x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat192.create();
        SecP192K1Field.negate(this.f766x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat192.create();
        SecP192K1Field.square(this.f766x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.subtract(this.f766x, ((SecP192K1FieldElement) eCFieldElement).f766x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat192.getBit(this.f766x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f766x);
    }
}
