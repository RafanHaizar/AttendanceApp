...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f776Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"));

    /* renamed from: x */
    protected int[] f777x;

    public SecP224K1FieldElement() {
        this.f777x = Nat224.create();
    }

    public SecP224K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f776Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224K1FieldElement");
        }
        this.f777x = SecP224K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP224K1Field.add(this.f777x, ((SecP224K1FieldElement) eCFieldElement).f777x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224K1Field.addOne(this.f777x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.f774P, ((SecP224K1FieldElement) eCFieldElement).f777x, create);
        SecP224K1Field.multiply(create, this.f777x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat224.m134eq(this.f777x, ((SecP224K1FieldElement) obj).f777x);
    }
    ...
    public int getFieldSize() {
        return f776Q.bitLength();
    }

    public int hashCode() {
        return f776Q.hashCode() ^ Arrays.hashCode(this.f777x, 0, 7);
    }

    public ECFieldElement invert() {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.f774P, this.f777x, create);
        return new SecP224K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat224.isOne(this.f777x);
    }

    public boolean isZero() {
        return Nat224.isZero(this.f777x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.multiply(this.f777x, ((SecP224K1FieldElement) eCFieldElement).f777x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224K1Field.negate(this.f777x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224K1Field.square(this.f777x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.subtract(this.f777x, ((SecP224K1FieldElement) eCFieldElement).f777x, create);
        return new SecP224K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat224.getBit(this.f777x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f777x);
    }
}
