...
public class SecT193Field {
    ...
    protected static void implMulwAcc(long j, long j2, long[] jArr, int i) {
        ...
        do {
            int i4 = (int) (j3 >>> i3);
            long j10 = (jArr2[(i4 >>> 12) & 7] << 12) ^ (((jArr2[i4 & 7] ^ (jArr2[(i4 >>> 3) & 7] << 3)) ^ (jArr2[(i4 >>> 6) & 7] << 6)) ^ (jArr2[(i4 >>> 9) & 7] << 9));
            j8 ^= j10 << i3;
            j9 ^= j10 >>> (-i3);
            i3 -= 15;
        } while (i3 > 0);
        jArr[i] = jArr[i] ^ (M49 & j8);
        int i5 = i + 1;
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j3 = (BodyPartID.bodyIdMax & unshuffle3) ^ (jArr[3] << 32);
