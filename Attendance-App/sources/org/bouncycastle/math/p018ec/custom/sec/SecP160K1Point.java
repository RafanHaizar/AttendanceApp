...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f729x, this.f730y.negate(), this.f731zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] create = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f761x, create);
        int[] create2 = Nat160.create();
        SecP160R2Field.square(create, create2);
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f761x, create3);
        SecP160R2Field.reduce32(Nat160.addBothTo(create3, create3, create3), create3);
        SecP160R2Field.multiply(create, secP160R2FieldElement2.f761x, create);
        ...
        SecP160R2Field.square(create3, secP160R2FieldElement4.f761x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f761x, create, secP160R2FieldElement4.f761x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f761x, create, secP160R2FieldElement4.f761x);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(create);
        SecP160R2Field.subtract(create, secP160R2FieldElement4.f761x, secP160R2FieldElement5.f761x);
        SecP160R2Field.multiply(secP160R2FieldElement5.f761x, create3, secP160R2FieldElement5.f761x);
        SecP160R2Field.subtract(secP160R2FieldElement5.f761x, create4, secP160R2FieldElement5.f761x);
