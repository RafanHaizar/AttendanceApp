...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    /* renamed from: g */
    private final GF2Matrix f855g;

    /* renamed from: n */
    private final int f856n;
    ...
    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.f856n = i;
        this.f857t = i2;
        this.f855g = new GF2Matrix(gF2Matrix.getEncoded());
        this.digest = algorithmIdentifier;
    }

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.f856n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f857t = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
        this.f855g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer((long) this.f856n));
        aSN1EncodableVector.add(new ASN1Integer((long) this.f857t));
        aSN1EncodableVector.add(new DEROctetString(this.f855g.getEncoded()));
