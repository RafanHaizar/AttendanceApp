...
public final class BigEndianConversions {
    ...
    public static int OS2IP(byte[] bArr, int i, int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            i3 |= (bArr[i + i4] & UByte.MAX_VALUE) << (((i2 - i4) - 1) * 8);
        }
        return i3;
    }
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        int i6 = i5 + 1;
        int i7 = i6 + 1;
        return ((long) (bArr[i7 + 1] & UByte.MAX_VALUE)) | ((((long) bArr[i]) & 255) << 56) | ((((long) bArr[i2]) & 255) << 48) | ((((long) bArr[i3]) & 255) << 40) | ((((long) bArr[i4]) & 255) << 32) | ((255 & ((long) bArr[i5])) << 24) | ((long) ((bArr[i6] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH)) | ((long) ((bArr[i7] & UByte.MAX_VALUE) << 8));
    }
