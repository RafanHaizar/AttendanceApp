    ...
    public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        if (asymmetricKeyParameter instanceof QTESLAPublicKeyParameters) {
            ...
            if (asymmetricKeyParameter instanceof XMSSPublicKeyParameters) {
                ...
                return new SubjectPublicKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.xmss, new XMSSKeyParams(xMSSPublicKeyParameters.getParameters().getHeight(), Utils.xmssLookupTreeAlgID(xMSSPublicKeyParameters.getTreeDigest()))), (ASN1Encodable) new XMSSPublicKey(xMSSPublicKeyParameters.getPublicSeed(), xMSSPublicKeyParameters.getRoot()));
