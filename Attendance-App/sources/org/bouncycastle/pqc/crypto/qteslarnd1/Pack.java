...
class Pack {
    ...
    public static void decodePrivateKeyI(byte[] bArr, short[] sArr, short[] sArr2, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < 512; i2 += 4) {
            int i3 = i2 + 0;
            short s = (short) (bArr2[i + 0] & UByte.MAX_VALUE);
            sArr[i3] = s;
            byte b = bArr2[i + 1];
            sArr[i3] = (short) (s | ((short) (((b & UByte.MAX_VALUE) << 30) >> 22)));
            int i4 = i2 + 1;
            short s2 = (short) ((b & UByte.MAX_VALUE) >> 2);
            sArr[i4] = s2;
            byte b2 = bArr2[i + 2];
            ...
            sArr[i6] = s4;
            sArr[i6] = (short) (s4 | ((short) (((short) bArr2[i + 4]) << 2)));
            i += 5;
        }
        for (int i7 = 0; i7 < 512; i7 += 4) {
            int i8 = i7 + 0;
            short s5 = (short) (bArr2[i + 0] & UByte.MAX_VALUE);
            sArr2[i8] = s5;
            byte b4 = bArr2[i + 1];
            sArr2[i8] = (short) (s5 | ((short) (((b4 & UByte.MAX_VALUE) << 30) >> 22)));
            int i9 = i7 + 1;
            short s6 = (short) ((b4 & UByte.MAX_VALUE) >> 2);
            sArr2[i9] = s6;
            byte b5 = bArr2[i + 2];
            ...
            sArr2[i11] = s8;
            sArr2[i11] = (short) (s8 | ((short) (((short) bArr2[i + 4]) << 2)));
            i += 5;
        }
    ...
    public static void decodePrivateKeyIIISpeed(byte[] bArr, short[] sArr, short[] sArr2, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < 1024; i2 += 8) {
            ...
            sArr[i3] = s;
            byte b = bArr2[i + 1];
            sArr[i3] = (short) (s | ((short) (((b & UByte.MAX_VALUE) << 31) >> 23)));
            int i4 = i2 + 1;
            short s2 = (short) ((b & UByte.MAX_VALUE) >> 1);
            sArr[i4] = s2;
            byte b2 = bArr2[i + 2];
            ...
            sArr[i10] = s8;
            sArr[i10] = (short) (s8 | ((short) (((short) bArr2[i + 8]) << 1)));
            i += 9;
        }
        for (int i11 = 0; i11 < 1024; i11 += 8) {
            int i12 = i11 + 0;
            short s9 = (short) (bArr2[i + 0] & UByte.MAX_VALUE);
            sArr2[i12] = s9;
            byte b8 = bArr2[i + 1];
            sArr2[i12] = (short) (s9 | ((short) (((b8 & UByte.MAX_VALUE) << 31) >> 23)));
            int i13 = i11 + 1;
            short s10 = (short) ((b8 & UByte.MAX_VALUE) >> 1);
            sArr2[i13] = s10;
            byte b9 = bArr2[i + 2];
            ...
            sArr2[i19] = s16;
            sArr2[i19] = (short) (s16 | ((short) (((short) bArr2[i + 8]) << 1)));
            i += 9;
        }
    ...
    public static void decodePublicKeyIIISpeed(int[] iArr, byte[] bArr, int i, byte[] bArr2) {
        ...
        for (int i3 = 0; i3 < 1024; i3 += 4) {
            ...
            int i6 = (i2 + 2) * 4;
            iArr[i3 + 2] = ((CommonFunction.load32(bArr2, i5) >>> 16) | (CommonFunction.load32(bArr2, i6) << 16)) & ViewCompat.MEASURED_SIZE_MASK;
    ...
    public static void decodeSignatureIIIP(byte[] bArr, long[] jArr, byte[] bArr2, int i) {
        ...
        for (int i3 = 0; i3 < 2048; i3 += 4) {
            ...
            int i6 = ((i2 + 2) * 4) + i;
            jArr[i3 + 2] = (long) (((CommonFunction.load32(bArr2, i5) >>> 16) & 65535) | ((CommonFunction.load32(bArr2, i6) << 24) >> 8));
    ...
    public static void encodePrivateKeyI(byte[] bArr, int[] iArr, int[] iArr2, byte[] bArr2, int i) {
        ...
        for (int i3 = 0; i3 < 512; i3 += 4) {
            ...
            int i6 = iArr[i3 + 2];
            bArr[i2 + 2] = (byte) (((i5 >> 6) & 15) | (i6 << 4));
            int i7 = iArr[i3 + 3];
            bArr[i2 + 3] = (byte) (((i6 >> 4) & 63) | (i7 << 6));
            bArr[i2 + 4] = (byte) (i7 >> 2);
            i2 += 5;
        }
        for (int i8 = 0; i8 < 512; i8 += 4) {
            ...
            bArr[i2 + 0] = (byte) i9;
            int i10 = iArr2[i8 + 1];
            bArr[i2 + 1] = (byte) (((i9 >> 8) & 3) | (i10 << 2));
            int i11 = iArr2[i8 + 2];
            bArr[i2 + 2] = (byte) (((i10 >> 6) & 15) | (i11 << 4));
            int i12 = iArr2[i8 + 3];
            bArr[i2 + 3] = (byte) (((i11 >> 4) & 63) | (i12 << 6));
            bArr[i2 + 4] = (byte) (i12 >> 2);
            i2 += 5;
        }
    ...
    public static void encodePrivateKeyIIISpeed(byte[] bArr, int[] iArr, int[] iArr2, byte[] bArr2, int i) {
        ...
        for (int i3 = 0; i3 < 1024; i3 += 8) {
            ...
            int i6 = iArr[i3 + 2];
            bArr[i2 + 2] = (byte) (((i5 >> 7) & 3) | (i6 << 2));
            int i7 = iArr[i3 + 3];
            bArr[i2 + 3] = (byte) (((i6 >> 6) & 7) | (i7 << 3));
            int i8 = iArr[i3 + 4];
            bArr[i2 + 4] = (byte) (((i7 >> 5) & 15) | (i8 << 4));
            int i9 = iArr[i3 + 5];
            bArr[i2 + 5] = (byte) (((i8 >> 4) & 31) | (i9 << 5));
            int i10 = iArr[i3 + 6];
            bArr[i2 + 6] = (byte) (((i9 >> 3) & 63) | (i10 << 6));
            int i11 = iArr[i3 + 7];
            bArr[i2 + 7] = (byte) (((i10 >> 2) & 127) | (i11 << 7));
            bArr[i2 + 8] = (byte) (i11 >> 1);
            i2 += 9;
        }
        for (int i12 = 0; i12 < 1024; i12 += 8) {
            ...
            bArr[i2 + 0] = (byte) i13;
            int i14 = iArr2[i12 + 1];
            bArr[i2 + 1] = (byte) (((i13 >> 8) & 1) | (i14 << 1));
            int i15 = iArr2[i12 + 2];
            bArr[i2 + 2] = (byte) (((i14 >> 7) & 3) | (i15 << 2));
            int i16 = iArr2[i12 + 3];
            bArr[i2 + 3] = (byte) (((i15 >> 6) & 7) | (i16 << 3));
            int i17 = iArr2[i12 + 4];
            bArr[i2 + 4] = (byte) (((i16 >> 5) & 15) | (i17 << 4));
            int i18 = iArr2[i12 + 5];
            bArr[i2 + 5] = (byte) (((i17 >> 4) & 31) | (i18 << 5));
            int i19 = iArr2[i12 + 6];
            bArr[i2 + 6] = (byte) (((i18 >> 3) & 63) | (i19 << 6));
            int i20 = iArr2[i12 + 7];
            bArr[i2 + 7] = (byte) (((i19 >> 2) & 127) | (i20 << 7));
            bArr[i2 + 8] = (byte) (i20 >> 1);
            i2 += 9;
        }
    ...
    public static void encodePublicKeyIP(byte[] bArr, long[] jArr, byte[] bArr2, int i) {
        ...
        for (int i3 = 0; i3 < 3712; i3 += 29) {
            int i4 = i2 + 1;
            CommonFunction.store32(bArr3, (i3 + 0) * 4, (int) (jArr[i2 + 0] | (jArr[i4] << 29)));
            int i5 = i2 + 2;
            CommonFunction.store32(bArr3, (i3 + 1) * 4, (int) ((jArr[i4] >> 3) | (jArr[i5] << 26)));
            int i6 = i2 + 3;
            CommonFunction.store32(bArr3, (i3 + 2) * 4, (int) ((jArr[i5] >> 6) | (jArr[i6] << 23)));
            int i7 = i2 + 4;
            CommonFunction.store32(bArr3, (i3 + 3) * 4, (int) ((jArr[i6] >> 9) | (jArr[i7] << 20)));
            int i8 = i2 + 5;
            CommonFunction.store32(bArr3, (i3 + 4) * 4, (int) ((jArr[i7] >> 12) | (jArr[i8] << 17)));
            int i9 = i2 + 6;
            CommonFunction.store32(bArr3, (i3 + 5) * 4, (int) ((jArr[i8] >> 15) | (jArr[i9] << 14)));
            int i10 = i2 + 7;
            CommonFunction.store32(bArr3, (i3 + 6) * 4, (int) ((jArr[i9] >> 18) | (jArr[i10] << 11)));
            int i11 = i2 + 8;
            CommonFunction.store32(bArr3, (i3 + 7) * 4, (int) ((jArr[i10] >> 21) | (jArr[i11] << 8)));
            int i12 = i2 + 9;
            CommonFunction.store32(bArr3, (i3 + 8) * 4, (int) ((jArr[i11] >> 24) | (jArr[i12] << 5)));
            int i13 = i2 + 11;
            CommonFunction.store32(bArr3, (i3 + 9) * 4, (int) ((jArr[i12] >> 27) | (jArr[i2 + 10] << 2) | (jArr[i13] << 31)));
            int i14 = i2 + 12;
            CommonFunction.store32(bArr3, (i3 + 10) * 4, (int) ((jArr[i13] >> 1) | (jArr[i14] << 28)));
            int i15 = i2 + 13;
            CommonFunction.store32(bArr3, (i3 + 11) * 4, (int) ((jArr[i14] >> 4) | (jArr[i15] << 25)));
            int i16 = i2 + 14;
            CommonFunction.store32(bArr3, (i3 + 12) * 4, (int) ((jArr[i15] >> 7) | (jArr[i16] << 22)));
            int i17 = i2 + 15;
            CommonFunction.store32(bArr3, (i3 + 13) * 4, (int) ((jArr[i16] >> 10) | (jArr[i17] << 19)));
            int i18 = i2 + 16;
            CommonFunction.store32(bArr3, (i3 + 14) * 4, (int) ((jArr[i17] >> 13) | (jArr[i18] << 16)));
            int i19 = i2 + 17;
            CommonFunction.store32(bArr3, (i3 + 15) * 4, (int) ((jArr[i18] >> 16) | (jArr[i19] << 13)));
            int i20 = i2 + 18;
            CommonFunction.store32(bArr3, (i3 + 16) * 4, (int) ((jArr[i19] >> 19) | (jArr[i20] << 10)));
            int i21 = i2 + 19;
            CommonFunction.store32(bArr3, (i3 + 17) * 4, (int) ((jArr[i20] >> 22) | (jArr[i21] << 7)));
            int i22 = i2 + 20;
            CommonFunction.store32(bArr3, (i3 + 18) * 4, (int) ((jArr[i21] >> 25) | (jArr[i22] << 4)));
            int i23 = i2 + 22;
            CommonFunction.store32(bArr3, (i3 + 19) * 4, (int) ((jArr[i22] >> 28) | (jArr[i2 + 21] << 1) | (jArr[i23] << 30)));
            int i24 = i2 + 23;
            CommonFunction.store32(bArr3, (i3 + 20) * 4, (int) ((jArr[i23] >> 2) | (jArr[i24] << 27)));
            int i25 = i2 + 24;
            CommonFunction.store32(bArr3, (i3 + 21) * 4, (int) ((jArr[i24] >> 5) | (jArr[i25] << 24)));
            int i26 = i2 + 25;
            CommonFunction.store32(bArr3, (i3 + 22) * 4, (int) ((jArr[i25] >> 8) | (jArr[i26] << 21)));
            int i27 = i2 + 26;
            CommonFunction.store32(bArr3, (i3 + 23) * 4, (int) ((jArr[i26] >> 11) | (jArr[i27] << 18)));
            int i28 = i2 + 27;
            CommonFunction.store32(bArr3, (i3 + 24) * 4, (int) ((jArr[i27] >> 14) | (jArr[i28] << 15)));
            int i29 = i2 + 28;
            CommonFunction.store32(bArr3, (i3 + 25) * 4, (int) ((jArr[i28] >> 17) | (jArr[i29] << 12)));
            int i30 = i2 + 29;
            CommonFunction.store32(bArr3, (i3 + 26) * 4, (int) ((jArr[i29] >> 20) | (jArr[i30] << 9)));
            int i31 = i2 + 30;
            CommonFunction.store32(bArr3, (i3 + 27) * 4, (int) ((jArr[i30] >> 23) | (jArr[i31] << 6)));
            CommonFunction.store32(bArr3, (i3 + 28) * 4, (int) ((jArr[i31] >> 26) | (jArr[i2 + 31] << 3)));
            i2 += 32;
        }
        System.arraycopy(bArr2, i, bArr3, 14848, 32);
    }
    ...
    public static void encodeSignature(byte[] bArr, int i, byte[] bArr2, int i2, int[] iArr, int i3, int i4) {
        ...
        while (true) {
            ...
            if (i5 < i7 / 32) {
                ...
                int i12 = ((iArr[i11] >>> 12) & 511) | ((iArr[i6 + 5] & 2097151) << 9);
                int i13 = i6 + 6;
                ...
                int i18 = ((iArr[i17] >>> 14) & 127) | ((iArr[i6 + 11] & 2097151) << 7);
                int i19 = i6 + 12;
                ...
                int i23 = i6 + 16;
                CommonFunction.store32(bArr, ((i5 + 10) * 4) + i, ((iArr[i22] >>> 5) & 65535) | (iArr[i23] << 16));
    ...
    public static void encodeSignatureIIISpeed(byte[] bArr, int i, byte[] bArr2, int i2, int[] iArr) {
        ...
        for (int i4 = 0; i4 < 704; i4 += 11) {
            ...
            int i12 = i3 + 8;
            CommonFunction.store32(bArr, ((i4 + 5) * 4) + i, ((iArr[i11] >>> 6) & 65535) | (iArr[i12] << 16));
    ...
    public static void encodeSignatureIP(byte[] bArr, int i, byte[] bArr2, int i2, long[] jArr) {
        ...
        for (int i5 = 0; i5 < 704; i5 += 11) {
            int i6 = i4 + 1;
            CommonFunction.store32(bArr3, ((i5 + 0) * 4) + i3, (int) ((jArr[i4 + 0] & 4194303) | (jArr[i6] << 22)));
            int i7 = i4 + 2;
            CommonFunction.store32(bArr3, ((i5 + 1) * 4) + i3, (int) (((jArr[i6] >>> 10) & 4095) | (jArr[i7] << 12)));
            int i8 = i4 + 4;
            CommonFunction.store32(bArr3, ((i5 + 2) * 4) + i3, (int) (((jArr[i7] >>> 20) & 3) | ((jArr[i4 + 3] & 4194303) << 2) | (jArr[i8] << 24)));
            int i9 = i4 + 5;
            CommonFunction.store32(bArr3, ((i5 + 3) * 4) + i3, (int) (((jArr[i8] >>> 8) & 16383) | (jArr[i9] << 14)));
            int i10 = i4 + 7;
            CommonFunction.store32(bArr3, ((i5 + 4) * 4) + i3, (int) (((jArr[i9] >>> 18) & 15) | ((jArr[i4 + 6] & 4194303) << 4) | (jArr[i10] << 26)));
            int i11 = i4 + 8;
            CommonFunction.store32(bArr3, ((i5 + 5) * 4) + i3, (int) (((jArr[i10] >>> 6) & 65535) | (jArr[i11] << 16)));
            int i12 = i4 + 10;
            CommonFunction.store32(bArr3, ((i5 + 6) * 4) + i3, (int) (((jArr[i11] >>> 16) & 63) | ((jArr[i4 + 9] & 4194303) << 6) | (jArr[i12] << 28)));
            int i13 = i4 + 11;
            CommonFunction.store32(bArr3, ((i5 + 7) * 4) + i3, (int) (((jArr[i12] >>> 4) & 262143) | (jArr[i13] << 18)));
            int i14 = i4 + 13;
            CommonFunction.store32(bArr3, ((i5 + 8) * 4) + i3, (int) (((jArr[i13] >>> 14) & 255) | ((jArr[i4 + 12] & 4194303) << 8) | (jArr[i14] << 30)));
            int i15 = i4 + 14;
            CommonFunction.store32(bArr3, ((i5 + 9) * 4) + i3, (int) (((jArr[i14] >>> 2) & 1048575) | (jArr[i15] << 20)));
            CommonFunction.store32(bArr3, ((i5 + 10) * 4) + i3, (int) (((jArr[i15] >>> 12) & 1023) | (jArr[i4 + 15] << 10)));
            i4 += 16;
        }
        System.arraycopy(bArr2, i2, bArr3, i3 + 2816, 32);
    }
