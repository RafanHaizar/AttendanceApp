        ...
        if (!this.recipientIDs.isEmpty()) {
            ...
            while (i != this.recipientIDs.size()) {
                ...
                try {
                    ...
                    if (!algorithm2.equals((ASN1Primitive) CryptoProObjectIdentifiers.id_Gost28147_89_None_KeyWrap)) {
                        if (!algorithm2.equals((ASN1Primitive) CryptoProObjectIdentifiers.id_Gost28147_89_CryptoPro_KeyWrap)) {
