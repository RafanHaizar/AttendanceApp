...
public abstract class PublicKeyDataObject extends ASN1Object {
    public static PublicKeyDataObject getInstance(Object obj) {
        ...
        return ASN1ObjectIdentifier.getInstance(instance.getObjectAt(0)).mo1052on(EACObjectIdentifiers.id_TA_ECDSA) ? new ECDSAPublicKey(instance) : new RSAPublicKey(instance);
    }
