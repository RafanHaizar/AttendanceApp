...
public class DHDomainParameters extends ASN1Object {
    ...
    /* renamed from: g */
    private ASN1Integer f97g;

    /* renamed from: j */
    private ASN1Integer f98j;

    /* renamed from: p */
    private ASN1Integer f99p;

    /* renamed from: q */
    private ASN1Integer f100q;
    ...
    public DHDomainParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, DHValidationParms dHValidationParms) {
        if (bigInteger == null) {
            ...
            this.f99p = new ASN1Integer(bigInteger);
            this.f97g = new ASN1Integer(bigInteger2);
            this.f100q = new ASN1Integer(bigInteger3);
            this.f98j = new ASN1Integer(bigInteger4);
    ...
    public DHDomainParameters(ASN1Integer aSN1Integer, ASN1Integer aSN1Integer2, ASN1Integer aSN1Integer3, ASN1Integer aSN1Integer4, DHValidationParms dHValidationParms) {
        if (aSN1Integer == null) {
            ...
            this.f99p = aSN1Integer;
            this.f97g = aSN1Integer2;
            this.f100q = aSN1Integer3;
            this.f98j = aSN1Integer4;
            this.validationParms = dHValidationParms;
        } else {
            throw new IllegalArgumentException("'q' cannot be null");
        }
    ...
    private DHDomainParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f99p = ASN1Integer.getInstance(objects.nextElement());
        this.f97g = ASN1Integer.getInstance(objects.nextElement());
        this.f100q = ASN1Integer.getInstance(objects.nextElement());
        ASN1Encodable next = getNext(objects);
        if (next != null && (next instanceof ASN1Integer)) {
            this.f98j = ASN1Integer.getInstance(next);
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f99p);
        aSN1EncodableVector.add(this.f97g);
        aSN1EncodableVector.add(this.f100q);
        ASN1Integer aSN1Integer = this.f98j;
        if (aSN1Integer != null) {
