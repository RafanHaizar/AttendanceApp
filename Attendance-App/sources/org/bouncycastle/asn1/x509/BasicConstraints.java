...
public class BasicConstraints extends ASN1Object {
    ...
    public BasicConstraints(int i) {
        this.f80cA = ASN1Boolean.getInstance(false);
        this.pathLenConstraint = null;
        this.f80cA = ASN1Boolean.getInstance(true);
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Boolean) {
            this.f80cA = ASN1Boolean.getInstance((Object) aSN1Sequence.getObjectAt(0));
        } else {
            this.f80cA = null;
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f80cA;
    ...
    public String toString() {
        ...
        if (this.pathLenConstraint != null) {
            append = new StringBuilder().append("BasicConstraints: isCa(").append(isCA()).append("), pathLenConstraint = ").append(this.pathLenConstraint.getValue());
        } else if (this.f80cA == null) {
            return "BasicConstraints: isCa(false)";
        } else {
            append = new StringBuilder().append("BasicConstraints: isCa(").append(isCA()).append(")");
        }
