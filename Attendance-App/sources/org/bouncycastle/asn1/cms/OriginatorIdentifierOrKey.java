...
public class OriginatorIdentifierOrKey extends ASN1Object implements ASN1Choice {
    ...
    public IssuerAndSerialNumber getIssuerAndSerialNumber() {
        ASN1Encodable aSN1Encodable = this.f19id;
    ...
    public OriginatorPublicKey getOriginatorKey() {
        ...
        return OriginatorPublicKey.getInstance((ASN1TaggedObject) this.f19id, false);
    }
    ...
    public SubjectKeyIdentifier getSubjectKeyIdentifier() {
        ...
        return SubjectKeyIdentifier.getInstance((ASN1TaggedObject) this.f19id, false);
    }

    public ASN1Primitive toASN1Primitive() {
        return this.f19id.toASN1Primitive();
    }
}
