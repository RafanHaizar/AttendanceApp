...
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier data = new ASN1ObjectIdentifier(SecurityIDs.ID_PKCS7_DATA).intern();
    ...
    public static final ASN1ObjectIdentifier signedData = new ASN1ObjectIdentifier(SecurityIDs.ID_PKCS7_SIGNED_DATA).intern();
