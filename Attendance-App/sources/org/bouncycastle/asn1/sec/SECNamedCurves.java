...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve access$100 = SECNamedCurves.configureCurve(new ECCurve.C0346Fp(access$000, access$0002, access$0003, access$0004, valueOf));
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(1);
            ECCurve access$300 = SECNamedCurves.configureCurveGLV(new ECCurve.C0346Fp(access$000, bigInteger, valueOf, access$0002, valueOf2), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240)));
    ...
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(4);
            ECCurve access$100 = SECNamedCurves.configureCurve(new ECCurve.F2m((int) TIFFConstants.TIFFTAG_YRESOLUTION, 5, 7, 12, bigInteger, valueOf, access$000, valueOf2));
    ...
    static X9ECParametersHolder sect283r1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new ECCurve.F2m((int) TIFFConstants.TIFFTAG_YRESOLUTION, 5, 7, 12, valueOf, access$000, access$0002, valueOf2));
