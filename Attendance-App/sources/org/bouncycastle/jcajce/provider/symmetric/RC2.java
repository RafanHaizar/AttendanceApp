...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f672iv);
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i = this.parameterVersion) != -1) {
                return i < 256 ? new RC2ParameterSpec(ekb[this.parameterVersion], this.f672iv) : new RC2ParameterSpec(this.parameterVersion, this.f672iv);
            }
            if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f672iv);
            }
