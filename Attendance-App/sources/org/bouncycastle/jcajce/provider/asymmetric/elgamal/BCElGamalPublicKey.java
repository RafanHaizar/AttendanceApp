...
public class BCElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    BCElGamalPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f659y = dHPublicKeySpec.getY();
    ...
    BCElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f659y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    BCElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f659y = elGamalPublicKeyParameters.getY();
    ...
    BCElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f659y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    BCElGamalPublicKey(ElGamalPublicKeySpec elGamalPublicKeySpec) {
        this.f659y = elGamalPublicKeySpec.getY();
    ...
    public byte[] getEncoded() {
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), (ASN1Encodable) new ASN1Integer(this.f659y)).getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            return null;
        }
    }
